...
create_clock -name adrv1_rx1_dclk_out   -period  2.034 [get_ports adrv1_rx1_dclk_in_p]
create_clock -name adrv1_rx2_dclk_out   -period  2.034 [get_ports adrv1_rx2_dclk_in_p]
create_clock -name adrv1_tx1_dclk_out   -period  2.034 [get_ports adrv1_tx1_dclk_in_p]
create_clock -name adrv1_tx2_dclk_out   -period  2.034 [get_ports adrv1_tx2_dclk_in_p]

create_clock -name adrv1_rx1_dclk_out   -period  2.034 [get_ports adrv2_rx1_dclk_in_p]
create_clock -name adrv1_rx2_dclk_out   -period  2.034 [get_ports adrv2_rx2_dclk_in_p]
create_clock -name adrv1_tx1_dclk_out   -period  2.034 [get_ports adrv2_tx1_dclk_in_p]
create_clock -name adrv1_tx2_dclk_out   -period  2.034 [get_ports adrv2_tx2_dclk_in_p]

# Allow max skew of 0.2 ns between input clocks
set_clock_latency -source -early -0.1 [get_clocks adrv1_rx1_dclk_out]
set_clock_latency -source -early -0.1 [get_clocks adrv1_rx2_dclk_out]

set_clock_latency -source -late 0.1 [get_clocks adrv1_rx1_dclk_out]
set_clock_latency -source -late 0.1 [get_clocks adrv1_rx2_dclk_out]

# Allow max skew of 0.2 ns between input clocks
set_clock_latency -source -early -0.1 [get_clocks adrv2_rx1_dclk_out]
set_clock_latency -source -early -0.1 [get_clocks adrv2_rx2_dclk_out]

set_clock_latency -source -late 0.1 [get_clocks adrv2_rx1_dclk_out]
set_clock_latency -source -late 0.1 [get_clocks adrv2_rx2_dclk_out]
